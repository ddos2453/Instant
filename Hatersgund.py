...
TOKEN = '7757765173:AAG-a07XG_iWY0Ee_R_zXTRyFBk6wMRBI8o'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002177231516
CHANNEL_ID = -1002177231516
error_channel_id = -1002177231516
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @radhe2206.*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*Please reach out to the owner for assistance: @radhe2206* 🙏"  # Contact owner message
    else:
